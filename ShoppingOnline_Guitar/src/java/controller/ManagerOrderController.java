...
//            request.setAttribute("listOrder", listOrder);
            ManagerDAO mana = new ManagerDAO();
            List<managerOrder> listManagerOrder = mana.getAllAccountOS();
            request.setAttribute("listManagerOrder", listManagerOrder);
            request.getRequestDispatcher("manageroder.jsp").forward(request, response);
